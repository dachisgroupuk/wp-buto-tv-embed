 ...
 */
class WpButoTvEmbedCore
{
    static $wpdb, $plugin_file, $plugin_path, $plugin_url;

    static $option_name = 'wpbte-settings';
    ...
    {
        $options = get_option( WpButoTvEmbedCore::$option_name );
    ...
    function save_options( $options )
    {
        ...
        update_option( WpButoTvEmbedCore::$option_name, $options);
